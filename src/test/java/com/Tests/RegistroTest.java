...
public class RegistroTest {
    ...
    void RegistroExitoso() throws  InterruptedException {
        ...
        registerPage.escribirFirstName("NombreTest1");
        registerPage.escribirLastName("ApellidoTest1");
        registerPage.escribirAddress("AddressTest1");
        registerPage.escribirCity("CityTest1");
        registerPage.escribirState("StateTest1");
        registerPage.escribirZipCode("ZipCodeTest1");
        registerPage.escribirTelephone("123456");
        registerPage.escribirSsn("123456");
        registerPage.escribirUsername("user18");
